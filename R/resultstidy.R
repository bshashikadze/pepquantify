#' Tidy the results generated by MS-EmpiRe
#'
...
#' @param data dataset retured from the read functions of the pepquantify package
#' @param data2 this is the output of the pepquantify package read functions
#' @return msempire_results
#' @export
...
cat("three files were saved in the directory
    1 - msempire_results_raw this is the raw results
    2 - msempire_results_tidy this is the dataset that has bee cleaned-up and can be used for suppl tables
    3 - msempire_results_tidy some columns was adjusted to make it suitable for the volcano plot")
}
