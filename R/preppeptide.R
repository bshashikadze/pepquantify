...
#' @description this function keeps only necessary columns that are important for the next steps. Importantly, samples will be reduced to a dual comparisons by passing proper group names in the condition1 and condition2.
...
#' @param n_element_peptide peptide data is nth element (usually not necessary to change)
#' @param min_pep minimum number of peptides
#' @return filtered_data_dual which is the list of 6. this output should always be generated but is only useful if imputation is performed
